...
EXTERN OS~UTIL~TERM.SET_VGA_COLOR
...
EXTERN OS~UTIL~TERM.CURSORY
EXTERN OS~UTIL~TERM.CURSORX



EXTERN OS~UTIL~TERM#VGA_HEIGHT
EXTERN OS~UTIL~TERM#VGA_WIDTH
...
%macro OS~UTIL~TERM.SET_COLOR_M 2
	...
	CALL OS~UTIL~TERM.SET_VGA_COLOR
%endmacro
